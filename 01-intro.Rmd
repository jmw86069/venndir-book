...
A Venn diagram without directionality cannot answer question 2.

Venndir proposes a simple extension to a Venn diagram: Place
[signed counts](#signed-counts) beside the [main counts](#main-counts).
[Signed counts](#signed-counts) summarize the directionality of
the [main counts](#main-counts). They are indicated using directional arrows,
up and down, together with color, red for up, and blue for down.
