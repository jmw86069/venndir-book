...
```{r textvenn-1-latex, echo=FALSE, eval=knitr::is_latex_output(), comment='', results='asis', dependson="html-latex-color"}
setlist <- make_venn_test(set_names=LETTERS[1:3])
#
...
```{r textvenn-3-latex, echo=FALSE, eval=knitr::is_latex_output(), comment='', results='asis', dependson="html-latex-color"}
...
```{r textvenn-4-latex, echo=FALSE, eval=knitr::is_latex_output(), comment='', results='asis', dependson="html-latex-color"}
setlist3 <- make_venn_test(set_names=LETTERS[1:3],
   do_signed=TRUE)
#
...
```{r textvenn-5-html, echo=FALSE, eval=knitr::is_html_output(), results='asis', dependson="textvenn-4-html"}
textvenn(setlist3,
   overlap_type="each",
   htmlOut=TRUE,
   template="tall")
...
```{r textvenn-5-latex, echo=FALSE, eval=knitr::is_latex_output(), comment='', results='asis', dependson="html-latex-color"}
