...
Figure \@ref(fig:advanced-signs-1e) demonstrates how to customize `curate_df`,
...
(ref:advanced-signs-1e) Venndir showing the custom signs 'up' and 'down' used to produce Unicode signs as before.

```{r advanced-signs-1e, fig.height=5, fig.width=6, echo=FALSE, fig.cap="(ref:advanced-signs-1e)", fig.alt="(ref:advanced-signs-1e)", dependson="advanced-signs-1", cache=FALSE}
curate_df <- get_venndir_curate_df()
