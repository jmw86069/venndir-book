...
Figure \@ref(fig:advanced-signs-1c) demonstrates how to customize `curate_df`,
...
```{r advanced-signs-1c, fig.height=5, fig.width=6, echo=FALSE, fig.cap="(ref:advanced-signs-1c)", fig.alt="(ref:advanced-signs-1c)"}
curate_df <- get_venndir_curate_df()
#
du_match <- match(c("-1", "1"), curate_df$from)
curate_df[du_match, "from"] <- c("dn", "up")
...
```{r advanced-signs-2, echo=FALSE, fig.ncol=2, out.width="50%", eval=FALSE, fig.height=5, fig.width=6, fig.cap="(ref:advanced-signs-2)", fig.alt="(ref:advanced-signs-2)", fig.subcap=c("Three signs.", "Three signs using Unicode.")}
setlist <- make_venn_test(n_items=150, n_sets=3, do_signed=TRUE,
   set_names=c("Set 1", "Set 2", "Set 3"))
set.seed(123)
setlist2 <- lapply(setlist, function(i){
