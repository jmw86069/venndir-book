...
Figure \@ref(fig:advanced-signs-1d) demonstrates how to customize `curate_df`,
...
(ref:advanced-signs-1d) Venndir showing the custom signs 'up' and 'down' used to produce Unicode signs as before.

```{r advanced-signs-1d, fig.height=5, fig.width=6, echo=FALSE, fig.cap="(ref:advanced-signs-1d)", fig.alt="(ref:advanced-signs-1d)", dependson="advanced-signs-1"}
curate_df <- get_venndir_curate_df()
#
du_match <- match(c("-1", "1"), curate_df$from)
curate_df[du_match, "from"] <- c("dn", "up")
